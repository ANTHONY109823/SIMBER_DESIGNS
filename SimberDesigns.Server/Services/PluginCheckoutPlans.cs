...
/// <summary>Planes de activación: 1 / 3 / 6 meses. Precio = mes × N con descuento por volumen
/// (3 meses −10%, 6 meses −20%). El monto se calcula SIEMPRE aquí (server-authoritative).</summary>
public static class PluginCheckoutPlans
{
        ...
        out string title)
    {
        ...
        title = months == 1
            ...
            : $"Activación {months} meses ({days} días) · {prog}{descTxt}";
        return true;
    }
